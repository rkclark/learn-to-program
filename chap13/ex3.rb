#Chris Pines dragon class from book, no indentation due to copy + paste!
class Dragon
def initialize name
@name = name
@asleep = false
...
puts 'Enter a name for your new pet dragon...'
name = gets.chomp
drag = Dragon.new name
while true
  puts 'You can give your pet the following commands: feed, toss, walk, rock, put to bed, exit'
  command = gets.chomp
  case command
  when "exit"
    exit
